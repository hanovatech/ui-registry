...
- Create helper registry items only when explicitly requested, not by default.
- Avoid importing `$lib/utils/shadcn.ts` from registry component source files; prefer local inline logic for small utilities such as class concatenation.
